  ...
  return (
    <div className="main-bg min-h-screen flex flex-col">
      <div className="container mx-auto px-4">
        {/* Hero banner with RPG/fantasy art, fallback logic, and drop-in asset comment */}
        <div className="hero-banner mt-6 w-full h-[180px] flex items-center justify-center rpg-rounded relative overflow-hidden shadow-lg mb-6">
          <img
            ...
            // TODO: To use your own art, add hero_banner.png to /src/assets and swap 'heroBannerUrl' to require('../assets/hero_banner.png')
          />
        </div>
        {/* ...rest of the layout */}
        <Outlet />
